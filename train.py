...
def main(cfg: DictConfig) -> None:
    ...
    mnist_train, mnist_val = random_split(mnist_full, [mnist_train_size, mnist_val_len], generator=gen)
    ...
    if cfg.training.use_ckpt:
        trainer.fit(model, train_dataloader, val_dataloader, ckpt_path=cfg.training.ckpt_path)
    else:
